...
The development of touch screens abstracted user interfaces. Decoupling the logical interface 
...
Sensitivity to rain, sweat, temperature, etc. makes them less reliable in harsh conditions.

WIP...

### Development of the Cons
There are some innovations such as fluid base tactiles, haptic feedback, localized vibration. 
However they do not fully make up for the loss of real physical interfaces.
